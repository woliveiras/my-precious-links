...
* [Poup Design](http://blog.popupdesign.com.br/){:target="_blank"}
...
* [Leandro Oriente](http://leandrooriente.com/){:target="_blank"}
* [Vitor Brito](http://blog.vitorbritto.com.br/){:target="_blank"}
* [Raio Frontendizador](http://jotateles.com.br/){:target="_blank"}
* [Willian Justen](http://willianjusten.com.br){:target="_blank"}
* [BrazilJS](http://braziljs.org/){:target="_blank"}
...
* [Clean Code: 1 Introdução](https://www.javascriptmasters.com.br/blog/teoria/clean-code-1-introducao/){:target="_blank"}
* [Clean Code: 2 O que é código limpo?](https://www.javascriptmasters.com.br/blog/teoria/clean-code-2-o-que-e-codigo-limpo/){:target="_blank"}
* [A Beginner’s Guide to HTTP and REST](http://code.tutsplus.com/tutorials/a-beginners-guide-to-http-and-rest--net-16340){:target="_blank"}
* [Secrets of the Browser Developer Tools](http://devtoolsecrets.com/){:target="_blank"}
* [MaintainableCSS](http://maintainablecss.com/){:target="_blank"}
...
* [Free programming books](https://github.com/vhf/free-programming-books){:target="_blank"}
* [Uma tradução em Português da série You Don't Know JS](https://github.com/cezaraugusto/You-Dont-Know-JS){:target="_blank"}
* [Front-End Developer Handbook](http://www.frontendhandbook.com){:target="_blank"}
* [Book of Modern frontend tooling](http://tooling.github.io/book-of-modern-frontend-tooling/){:target="_blank"}
* [Free Learning - Free Technology eBooks, Packt Publishing](https://www.packtpub.com/packt/offers/free-learning){:target="_blank"}
...
* [Mastering the Module Pattern](https://toddmotto.com/mastering-the-module-pattern/){:target="_blank"}
* [Dev Tools Challenger](http://devtoolschallenger.com/){:target="_blank"}
* [Service Worker Cookbook](https://serviceworke.rs/){:target="_blank"}
* [Single page apps in depth](http://singlepageappbook.com/){:target="_blank"}
* [Can You “Over Organize” JavaScript?](https://css-tricks.com/can-you-over-organize-javascript/){:target="_blank"}
* [How Do You Structure JavaScript? The Module Pattern Edition](https://css-tricks.com/how-do-you-structure-javascript-the-module-pattern-edition/){:target="_blank"}
* [The legend of JavaScript equality operator](http://rainsoft.io/the-legend-of-javascript-equality-operator/){:target="_blank"}
* [JavaScript Jargons](http://jargon.js.org/){:target="_blank"}
...
* [Minimizing boilerplate with NPM & Makefiles](https://medium.com/@tjholowaychuk/minimizing-boilerplate-with-npm-makefiles-3cfdce2934e7#.vdlnvmtm9){:target="_blank"}
* [You Don’t Know Node: Quick Intro to Core Features](http://webapplog.com/you-dont-know-node/#main){:target="_blank"}
...
* [Dirty Tricks From The Dark Corners Of Front-End (Slides, PDF)](https://www.smashingmagazine.com/2016/03/dirty-tricks-dark-corners-front-end-slides-pdf/){:target="_blank"}
* [PX, EM or REM Media Queries?](http://zellwk.com/blog/media-query-units/){:target="_blank"}
* [You don’t need Grunt](https://medium.com/@julesbou/you-don-t-need-grunt-a48605915319#.ur7cyf7kd){:target="_blank"}
...
* [Public APIs](https://github.com/toddmotto/public-apis){:target="_blank"}
...
* [Elixir School](https://elixirschool.com/pt/lessons/basics/basics/){:target="_blank"}

##### Golang

* [An Introduction to Programming in Go](http://www.golang-book.com/books/intro){:target="_blank"}
* [Building Web Apps with Go](https://codegangsta.gitbooks.io/building-web-apps-with-go/content/index.html){:target="_blank"}
* [Build Web Application with Golang](https://astaxie.gitbooks.io/build-web-application-with-golang/content/en/index.html){:target="_blank"}
...
* [A collection of awesome penetration testing resources, tools and other shiny things](https://github.com/enaqx/awesome-pentest){:target="_blank"}


##### Podcasts

* [Foocast](http://foocast.io/){:target="_blank"}
* [Grokpodcast](http://www.grokpodcast.com){:target="_blank"}
